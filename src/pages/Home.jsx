...
export function Home() {
  ...
  const textSections = useMemo(() => {
    return [
      {
        text1: `Hello there! I'm Synnie Xinyi Li,`,
      ...
      },
      {
        ...
        text2: `I embraced the role of a creative developer at a  company.`,
      },
      {
      ...
      >
        ...
        {progress === 100 && (
          <>
            ...
            <div className={`intro ${!play & !hasDrag ? "" : "scroll-appear"}`}>
              <h3 className="logo-title">Synnie's Journey</h3>
            </div>
          </>
        )}
      </div>
        ...
        {section >= 0 && (
          <div className="card">
            <p className="card-text">
              {textSections[Math.floor(section / step)].text1}
            </p>
            <p className="card-text">
              {textSections[Math.floor(section / step)].text2}
            </p>
          </div>
        )}
      </div>
